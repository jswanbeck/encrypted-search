  ...
  <div class="container">
    ...
    <div class="row">
      <div class="twelve columns">
        <h4 style="margin-bottom: 0">Search Documents</h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="twelve columns" style="margin-top: .2rem">
        <form action="" method="POST" style="margin-bottom: 0"> <!-- Content form (POST) -->
          ...
          <div id="btnSearch" class="two columns" style="margin-right: 0">
            <input type="submit" class="actionButton" formaction="search" value="Search"> <!-- Search button -->
          </div>
          <div id="txtSearch" class="ten columns" style="margin-right: 0; float: left">
            <input type="text" name="search" placeholder="Search Input" style="width: 104.8%">  <!-- Search textbox -->
          </div>
        </form>
      </div>
    </div>
