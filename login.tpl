    ...
    <div class="row">
      <div class="twelve columns" style="margin-top: .2rem; margin-left: 25%; width: 50%">
        <form action="" style="margin-bottom: 0; text-align: center" method="POST">
          ...
          <input type="submit" formaction="login" style="width: 47.5%; margin-bottom: 1.5rem; margin-right: 1%; margin-left: 1%" value="Login">
          <input type="submit" formaction="password_reset" style="width: 47.5%; margin-bottom: 1.5rem; margin-right: 1%; margin-left: 1%" value="Forgot Password">
        </form>
